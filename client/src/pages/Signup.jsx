...
import { Contact, User, Mail, Lock, ArrowRight, ShieldCheck } from "lucide-react";
...
function Signup() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-mesh-gradient flex items-center justify-center px-4 py-12 overflow-hidden text-slate-800">
      {/* Light Pastel Ambient Glows */}
      <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-purple-200/60 blur-3xl pointer-events-none animate-pulse-glow" />
      <div className="absolute -bottom-32 -left-32 h-96 w-96 rounded-full bg-emerald-200/60 blur-3xl pointer-events-none animate-pulse-glow" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-8 text-center flex flex-col items-center">
          ...
          <p className="mt-1 text-sm font-semibold text-purple-700/80">
            Join Nexus Contacts to organize your network
          </p>
        </div>
        ...
        <div className="rounded-3xl bg-white/90 backdrop-blur-xl border border-purple-100 p-7 sm:p-9 shadow-xl shadow-purple-900/5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-purple-100 bg-purple-50/40 py-2.5 pl-10 pr-4 text-sm font-medium text-slate-800 placeholder-purple-300 outline-none transition duration-200 focus:border-purple-400 focus:bg-white focus:ring-4 focus:ring-purple-100"
                />
              </div>
            </div>
          ...
          <div className="mt-6 border-t border-purple-100/80 pt-4 text-center text-xs font-semibold text-slate-500">
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-emerald-800 text-xs font-bold rounded-full bg-emerald-100/80 px-4 py-1.5 w-fit mx-auto">
          <ShieldCheck size={15} className="text-emerald-600" />
          <span>Encrypted Data & Privacy First</span>
        </div>
